...
C10         READ(1,'(2(1X,1P,E14.7))',END=11) TIME(I),DATA(I)
10         READ(1,*,END=11) TIME(I),DATA(I)
           I= I+1
           IF(I.GT.N)THEN
       WRITE(*,*) 'RDDATA: data exceeds array size, truncating at N=',N
              GOTO 11
           ENDIF
           GOTO 10
11      CONTINUE
...
10         READ(1,'(3(1X,1P,E14.7))',END=11) FREQ(I),SPEC(I)
           I= I+1
           IF(I.GT.M)THEN
      WRITE(*,*) 'RDSPEC: data exceeds array size, truncating at M=',M
              GOTO 11
           ENDIF
           GOTO 10
11      CONTINUE
